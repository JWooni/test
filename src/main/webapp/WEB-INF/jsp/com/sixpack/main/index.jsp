...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="/widgets.do"><em class="fa fa-calendar">&nbsp;</em> Widgets</a></li>
			<li><a href="/charts.do"><em class="fa fa-bar-chart">&nbsp;</em> Charts</a></li>
			<li><a href="/elements.do"><em class="fa fa-toggle-off">&nbsp;</em> UI Elements</a></li>
			<li><a href="/panels.do"><em class="fa fa-clone">&nbsp;</em> Alerts &amp; Panels</a></li>
			...
			<li><a href="/login.do"><em class="fa fa-power-off">&nbsp;</em> Logout</a></li>
		</ul>
	</div><!--/.sidebar-->
